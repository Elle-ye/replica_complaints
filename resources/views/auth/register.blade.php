            ...
            <div class="w-100 m-auto">
                <form class="" action="{{ route('register') }}" method="POST" id="registerForm">
                    ...
                    <div class="form-group">
                        <label class="" for="form6Example1">First name</label>
                        <input type="text" id="form6Example1" class="" name="fname"
                    ...
                    <div class="form-group">
                        <label class="" for="form6Example2">Last name</label>
                        <input type="text" id="form6Example2" class="" name="lname"
                    ...
                    <div class="form-group mb-4">
                        <label class="" for="password_confirmation">Password</label>
                        <div class="password-wrapper">
                        <input type="password" id="password_confirmation" class="" name="password_confirmation"
                            required />
                    ...
                    <!-- Submit button -->
                    <button type="submit" name="submit" class="primary outline" id="registerBtn">Register</button>
